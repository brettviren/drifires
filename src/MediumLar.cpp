...
bool MediumLar::ElectronVelocity(
...
bool MediumLar::ElectronTownsend(const double, const double, const double,
                                 const double, const double, const double,
                                 double& alpha) {
    alpha=0.0;
    return true;
}
bool MediumLar::ElectronAttachment(const double, const double, const double,
                                   const double, const double, const double,
                                   double& eta)
{
    eta=0.0;
